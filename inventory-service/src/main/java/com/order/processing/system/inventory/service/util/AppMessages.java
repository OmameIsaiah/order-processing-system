...
public class AppMessages {
    ...
    public static final String MIN_PRODUCT_QUANTITY_EXCEEDED = "Oops! Product stock quantity cannot be less than 1, please check.";
    ...
    public static final String PRODUCT_ALREADY_EXISTS = "Oops! A product with this name already, kindly use another name or update the stock availability.";
