...
REM call docker network create --driver bridge prod_order_ps_network
REM docker network rm prod_order_ps_network
call docker network create --driver bridge --subnet=173.21.0.0/16 --ip-range=173.21.1.0/24 prod_order_ps_network
